package cc.dreamcode.ffa.mcversion.v1_12_R1;
...
public class V1_12_R1_ItemIdentifyManager implements ItemIdentifyManager {

    public String getItemIdentityTagName(ItemStack item, String key){
        net.minecraft.server.v1_12_R1.ItemStack itemClone = CraftItemStack.asNMSCopy(item);
